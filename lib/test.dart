///this is for $domain/api/doctor/appointment-schedule          for testing purpose that data is coming or not. data is coming successfully.
///so below url data is actually empty. that's mean data is not coming from server
///the main url is
///'$domain/api/doctor/appointment/history';
...
//     createdAt: DateTime.parse(json["created_at"]),
//     updatedAt: DateTime.parse(json["updated_at"]),
//     gender: json["gender"].toString(), //json["gender"] == null ? null : json["gender"],
